# Powerlevel10k disabled: use a clean prompt with no rounded/powerline segments.
...
__conda_setup="$('/Users/paolodeidda/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
alias tesi='cd ~/Documents/UNI/Master/Tesi/'
alias pms='cd ~/Documents/Work/Custodia/'
